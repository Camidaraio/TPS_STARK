...
#     nombre = heroe["nombre"].replace("the","")
...
#         iniciales_nombre.append(inicial)
        
#     iniciales_nombre = '.'.join(iniciales_nombre)
#     iniciales.append(iniciales_nombre)
...
#     lista_nombres.extend(palabras_nombre)
# print(lista_nombres)
